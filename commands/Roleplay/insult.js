...
const insult = insulter.Insult();
    ...
    if (member.id == 543031298130837510){
      return message.channel.send(`https://tenor.com/view/kick-balls-kick-in-the-balls-gif-12707456`)
    }
		...
		if (member.user.username === message.author.username) {
			...
			try {
				...
				.setTitle(`${message.author.username} insults ${member.user.username}`)
