 ...
 async execute(message, args, cmd, client, Discord) {
    ...
    const embed2 = new MessageEmbed()
      ...
      .addFields({
        ...
        name: '<:jarvy_rarrowpurple:892715864158261259>Uptime',
        value: `\`\`\`\n${prettyMilliseconds(os.uptime() * 1000, { verbose: true })}\n\`\`\``,
        inline: true
      }, {
