module.exports = {
  ...
  alises: ["wd"],
  description:
    "Shows the last 5 logged msg deletes. **It does NOT show messages deleted by bots, or self message deletes",
  async execute(message, args, cmd, client, Discord) {
    ...
    if (fetchedLogs.entries.size < 5) {
      message.channel.send({
        content:
          "This command requires at least 5 deleted msgs in the server, without that the cmd won't work",
      });
    } else {
